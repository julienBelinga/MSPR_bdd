CREATE OR REPLACE FUNCTION get_total_quantity_for_one_waste_type_by_siret(waste_type CHAR, site_siret_number NUMBER, start_date CHAR, end_date CHAR)
RETURN NUMBER
IS
...
BEGIN
    ...
    --For testing
select rnatio.get_total_quantity_for_one_waste_type_by_siret('papier',38238166300014, '11/08/2017', '11/08/2022') as quantite_relevee from dual;